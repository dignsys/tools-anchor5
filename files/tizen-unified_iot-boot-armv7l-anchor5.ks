...
part /lib/modules --fstype="ext4" --size=24 --ondisk=mmcblk0 --active --label modules --fsoptions=defaults,noatime
...
# @ IoT Boot Artik 530
anchor5-linux-kernel
anchor5-linux-kernel-modules
